...
public class TimerFragment extends Fragment {
    ...
    private com.example.cn_chen.aac.viewmodel.MainActModel mViewModel;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        Log.d("[TimerFragment]", " onActivityCreated!");
        ...
        Observer<Long> myObserver = new Observer<Long>() {
            ...
            public void onChanged(@Nullable Long aLong) {
                mTimerText.setText("MVVM Timer in fragment: " + aLong + "");
                Log.d("AAC", "[onChanged] timer");
            }
        };
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTimerText = root.findViewById(R.id.fragment_text);
        return root;
    }
